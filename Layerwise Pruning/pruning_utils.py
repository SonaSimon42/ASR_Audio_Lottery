...
def pruning_model(model, px):
    ...
    layer_partition_size = len(parameters_to_prune)//3

    initial_layers = parameters_to_prune[0:layer_partition_size]
    middle_layers = parameters_to_prune[layer_partition_size:2*layer_partition_size]
    final_layers = parameters_to_prune[2*layer_partition_size:len(parameters_to_prune)]
